        ...
        <div class="w-10/12 mx-auto">
            <div class="md:w-5/12">
                ...
                <div class="">
                    ...
                    <a aria-label="Find out more!" href="/activity-list" class="text-white font-bold font-roboto">
                        <div class="flex justify-end gap-3 mt-2">
                            <button class="px-6 py-1 bg-[#1FACCB]">
                                Next
                            </button>
                            <button class="px-3 py-1 bg-[#1FACCB]" role="button" type="button" aria-label="See More Button" title="See More">
