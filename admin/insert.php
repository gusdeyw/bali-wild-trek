        ...
        <div class="container px-6 mx-auto grid">
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs bg-white p-4 dark:bg-gray-800">
            <div class="w-full overflow-x-auto">
              <form class="" action="insert_process.php" method="POST">
                <div class="mb-4">
                ...
                <div class="mb-4">
                  ...
                  <input class="shadow dark:text-white dark:border-gray-600 dark:bg-gray-700 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="price" name="price" type="number" placeholder="Price">
                </div>
                <div class="mb-4">
