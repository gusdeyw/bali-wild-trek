    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <span>View more &RightArrow;</span>
                    ...
                    <!-- New Table -->
                    <div
                        class="w-full overflow-hidden rounded-lg shadow-xs bg-white p-4 dark:text-white dark:bg-gray-800">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex">
                                                ...
                                                <a href="delete_process.php?id=<?= $id ?>"><button
                                                        class="p-2 bg-purple-600 text-white rounded-md font-bold ml-3">Delete</button>
                                                </a>
                                            </div>
                                        </td>
                                        <td>
